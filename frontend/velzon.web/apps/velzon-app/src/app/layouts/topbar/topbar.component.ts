...
import { Component, OnInit, EventEmitter, Output, Inject, ViewChild, TemplateRef, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
import { NgbModal, NgbDropdown, NgbDropdownToggle, NgbDropdownMenu, NgbNav, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavLinkBase, NgbNavContent, NgbNavOutlet } from '@ng-bootstrap/ng-bootstrap';
...
@Component({
		...
		imports: [FormsModule, SimplebarAngularModule,  NgbDropdown, NgbDropdownToggle, NgbDropdownMenu, RouterLink, NgbNav, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavLinkBase, NgbNavContent, NgClass, NgbNavOutlet]
})
