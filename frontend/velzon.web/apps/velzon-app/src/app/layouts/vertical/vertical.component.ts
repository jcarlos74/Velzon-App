...
import { getSidebarSize } from '@velzon.web/store/layout-selector';
...
@Component({
    ...
    standalone: true,
    imports: [TopbarComponent, SidebarComponent,  FooterComponent, RightsidebarComponent,RouterOutlet]
})
