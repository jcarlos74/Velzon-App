...
//        public DbContext(string connectionString, string schema = "siltec", string dataBaseDialect = "PostgreSQL", string dataBaseProvider = "Npgsql",int tenant = 0) //"Oracle.ManagedDataAccess.Client"
//        {
...
//        {
//            if (_dataBaseProvider == "Npgsql" && _idTenant > 0)
//            {
