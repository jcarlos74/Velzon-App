...
import { RootReducerState } from '@velzon.web/store';
import { Store } from '@ngrx/store';
import { getLayoutMode, getLayoutPosition, getLayoutTheme, getLayoutWith, getPreloader, getSidebarColor, getSidebarImage, getSidebarSize, getSidebarView, getSidebarVisibilitye, getTopbarColor } from '@velzon.web/store/layout-selector';
import { changeDataPreloader, changeLayoutPosition, changeLayoutWidth, changeMode, changeSidebarColor, changeSidebarImage, changeSidebarSize, changeSidebarView, changeSidebarVisibility, changeTopbar, changelayout } from '@velzon.web/store/layout-action';
...
@Component({
    ...
    standalone: true,
    imports: [SimplebarAngularModule, NgIf]
})
